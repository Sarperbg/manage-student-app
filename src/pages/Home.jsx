          ...
          <form onSubmit={handleSubmit}>
            <div className='flex flex-col mt-6'>
              ...
              <div className='w-[90%] mx-auto  overflow-hidden'>
                ...
                <input
                  type="text"
                  {...errors.email && <p className='text-red-400 text-lg'>{errors.name}</p>}
              ...
              <div className='w-[90%] mx-auto mt-6  overflow-hidden'>
                <div className='w-full ml-4 mx-auto h-[44px] bg-[#FEAF00] flex justify-center items-center'>
                  <Link to="/dashboard" className=' text-[14px] text-[#FFFFFF] font-Montserrat '>SIGN IN</Link>

                </div>
                <div className='w-full mt-6 text-[14px] flex justify-center items-center gap-x-1'>
